...
The HR Team.`;
  ...
  return (
    <div className="space-y-6">
      ...
      <div id="mailing-resend-key-box" className="bg-white p-5 rounded-2xl border border-gray-150/80 shadow-sm relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-6 gap-6">
        ...
        <div className="lg:col-span-2 space-y-4">
          <div id="mailing-job-select-container" className="bg-white p-4 rounded-2xl border border-gray-150/80 shadow-sm space-y-3">
        ...
        <div className="lg:col-span-4">
          {!selectedJobId ? (
            ...
            <div className="bg-white p-5 md:p-6 rounded-2xl border border-gray-150/80 shadow-sm space-y-6">
              ...
              <div id="email-template-section" className="p-4 bg-slate-50 border border-gray-150 rounded-xl space-y-3">
              ...
              <div id="mailing-recipients-container" className="space-y-2">
