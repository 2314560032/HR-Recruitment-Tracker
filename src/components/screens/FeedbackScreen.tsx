...
export const FeedbackScreen: React.FC<FeedbackScreenProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <div id="feedback-cascading-filters" className="bg-white p-5 rounded-2xl shadow-sm border border-gray-150/80 grid grid-cols-1 md:grid-cols-2 gap-5">
      ...
      {!isSelectionMade ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
          {/* Left Column (33%): Position scope and Candidate selector list */}
                  ...
                  {linkedApplications.map((app) => {
                    ...
                    return (
                      <div
                        ...
                        className="p-3 bg-gray-55/40 rounded-xl border border-gray-150/70 flex items-center justify-between gap-3"
                      >
                        <div className="space-y-0.5 truncate flex-grow">
                          <strong className="text-xs font-bold text-gray-850 truncate block">
                            {app.candidateName}
                          </strong>
                        ...
                        {isInterviewStage ? (
                          ...
                          <span className="shrink-0 text-[8.5px] bg-amber-50 text-amber-850 px-2 py-1 rounded-md uppercase font-bold tracking-wide border border-amber-200/50 scale-90">
                            Locked
                          </span>
                        )}
                      </div>
          ...
          {/* Right Column (66%): Agregated scores statistics, interactive filter bar, and evaluations reviews list */}
          <div className="lg:col-span-2 space-y-6">
            {/* Evaluations count & average score card */}
            <div id="feedback-assessments-summary" className="bg-white p-5 rounded-2xl border border-gray-150/80 shadow-sm flex items-center justify-between">
              <div className="space-y-1">
              ...
              <div className="bg-[#F0FAF4]/40 p-4 rounded-2xl border border-[#D8F3DC] flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <div className="min-w-[150px]">
                    <select
                      className="w-full h-10 px-3 bg-white border border-gray-205 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#52B788] text-xs font-semibold text-gray-700 bg-white"
                      value={recFilter}
