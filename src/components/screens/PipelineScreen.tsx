  ...
  return (
    <div className="space-y-6 h-full flex flex-col">
      ...
      <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-150/80 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        {/* Selected Dropdown */}
        <div id="pipeline-select-container" className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                    ...
                    columnApps.map((app) => {
                      ...
                      return (
                        <div
                          ...
                          className="pipeline-card p-3 bg-white hover:bg-slate-50 border border-gray-150 rounded-xl shadow-sm hover:shadow transition-all relative overflow-hidden flex flex-col justify-between gap-3 cursor-pointer group w-full"
                        >
                          {/* Inner info */}
