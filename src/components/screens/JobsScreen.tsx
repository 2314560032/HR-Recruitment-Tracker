...
export const JobsScreen: React.FC<JobsScreenProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <div id="jobs-filter-bar" className="bg-white p-4 rounded-2xl shadow-sm border border-gray-150/80 flex flex-col md:flex-row md:items-center justify-between gap-4">
      ...
      <div id="jobs-table" className="bg-white rounded-2xl shadow-sm border border-gray-150/80 overflow-hidden">
