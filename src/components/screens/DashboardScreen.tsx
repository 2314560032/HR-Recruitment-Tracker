...
export const DashboardScreen: React.FC<DashboardScreenProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <div id="cohort-select-container" className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-white p-5 rounded-2xl border border-gray-150/80 shadow-sm">
        <div>
      ...
      {/* KPI Section */}
      <div id="dashboard-kpi-grid" className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-5">
        {/* Card 1: Open Jobs */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div id="dashboard-funnel-container" className="bg-white p-6 rounded-2xl shadow-sm border border-gray-150/80 lg:col-span-2">
        ...
        <div id="dashboard-gauge-container" className="bg-[#0F1F18] p-6 rounded-2xl shadow-xl text-white relative overflow-hidden flex flex-col justify-between group">
