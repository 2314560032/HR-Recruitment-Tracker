    ...
    <div className="space-y-6">
      ...
      {activeTab === "candidates" && (
        <div className="space-y-4">
          {/* Controls Bar */}
          <div id="candidates-cand-filter-bar" className="bg-white p-4 rounded-2xl shadow-sm border border-gray-150/80 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div id="candidates-cand-table" className="bg-white rounded-2xl shadow-sm border border-gray-150/80 overflow-hidden">
                                ...
                                <div className="flex items-center gap-2">
                                  ...
                                  >
                                    <span
                                      ...
                                      style={{ backgroundColor: isPrimaryJobClosed ? "#4B5563" : getStageColorDot(primaryApp.stage) }}
                                    />
                                    <span className="truncate max-w-[100px]" title={primaryApp.jobTitle}>
                                      {primaryApp.jobTitle}
                                    </span>
                                    <span className={`text-[10px] px-1.5 py-0.2 rounded font-bold uppercase ${
                                      isPrimaryJobClosed ? "bg-gray-200 text-gray-600" : "bg-slate-100 text-slate-800"
                                    }`}>
                                      {primaryApp.stage}
                                    </span>
                                  </button>
                                  ...
                                  {candApps.length > 1 && (
                                    <span
                                      className="px-2 py-0.5 rounded-full bg-gray-100 border border-gray-200 text-[10px] font-bold text-gray-600 select-none cursor-default"
                                        ...
                                        return (
                                          <div
                                            ...
                                            className={`flex flex-col sm:flex-row sm:items-center justify-between p-3.5 text-xs gap-3 transition-colors ${
                                              isJobClosed
                                                ? "bg-slate-50/80 opacity-70 border-b border-slate-150 text-slate-500"
                                                : "hover:bg-gray-50/80 bg-white border-b border-gray-100 text-gray-855"
                                            }`}
                                          >
                                            {/* Left details */}
                                            <div className="space-y-1">
                                              <p className={`font-bold ${isJobClosed ? "text-slate-600" : "text-gray-800"}`}>
                                                Position Applied:{" "}
                                                <span className={isJobClosed ? "text-slate-500 font-medium" : "text-[#2D6A4F]"}>
                                                  {app.jobTitle}
                                                </span>
                                              </p>
                                              <p className={`text-[10px] font-mono ${isJobClosed ? "text-slate-400" : "text-gray-400"}`}>
                                            ...
                                            <div className="flex flex-wrap items-center gap-3">
                                              {/* Stage */}
                                              {isJobClosed ? (
                                                <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 bg-gray-200 text-gray-600 rounded-full font-semibold text-[10px] uppercase tracking-wider border border-gray-305 shadow-sm">
                                              ...
                                              <span className={`px-2 py-0.5 rounded-md font-mono font-medium border ${
                                                ...
                                                Avg Score:{" "}
                                                <strong className={isJobClosed ? "text-slate-700" : "text-gray-800"}>
                                                  {details.roundedAvg}
                                                </strong>{" "}
                                                ({details.count} evals)
                                              </span>
                                            ...
                                            <div className="flex items-center gap-2" onClick={(e) => e.stopPropagation()}>
                                              ...
                                              <button
                                                ...
                                                className={`p-1 px-2.5 rounded-lg border disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer min-h-[36px] flex items-center gap-1 transition-all text-[11px] font-semibold ${
                                                  isJobClosed
                                                    ? "border-amber-200 text-amber-655 bg-slate-50 hover:bg-amber-50"
      ...
      {activeTab === "applications" && (
        <div className="space-y-4">
          ...
          <div id="candidates-app-filter-bar" className="bg-white p-4 rounded-2xl shadow-sm border border-gray-150/80 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="flex flex-wrap items-center gap-3">
              {/* Search text query */}
          ...
          <div id="candidates-app-table" className="bg-white rounded-2xl shadow-sm border border-gray-150/80 overflow-hidden">
            <div className="overflow-x-auto scrollbar-thin">
              <table className="w-full border-collapse text-left text-sm table-auto">
                <thead>
                  <tr className="bg-[#F0FAF4]/60 border-b border-gray-100 text-gray-500 font-semibold text-xs uppercase tracking-wider">
                    ...
                    paginatedApplications.map((app, index) => {
                      ...
                      return (                        <tr
                          ...
                          className={`transition-colors cursor-pointer border-b ${
                            isJobClosed
                              ? "bg-slate-50/80 opacity-70 border-slate-150 hover:bg-slate-100/50"
                        ...
                        >
                          ...
                          <td className={`py-4 px-6 sticky left-0 z-10 font-bold shadow-sm md:shadow-none min-w-[160px] ${
                            isJobClosed
                              ? "bg-slate-50/80 text-slate-600 md:bg-transparent"
                            ...
                            <div className="flex items-center gap-2">
                              <div>
                                ...
                                <span className={`block text-[9px] font-mono font-medium ${
                                  isJobClosed ? "text-slate-400" : "text-gray-400"
                                }`}>
                                  {app.applicationId}
                                </span>
                              </div>
                          ...
                          <td className={`py-4 px-6 ${isJobClosed ? "text-slate-500" : "text-gray-600"}`}>
                          ...
                          <td className="py-4 px-6">
                            <div>
                              <span className={`block font-semibold ${isJobClosed ? "text-slate-600" : "text-gray-800"}`}>
                                {app.jobTitle}
                              </span>
                          ...
                          <td className="py-4 px-6">
                            {isJobClosed ? (
                              <span
                                className="inline-flex items-center gap-1.5 px-3 py-1 bg-gray-200 text-gray-600 rounded-full text-xs font-bold uppercase tracking-wider shadow-sm border border-gray-305"
                              >
                                <span className="w-1.5 h-1.5 bg-gray-500 rounded-full inline-block" />
                                {app.stage}
                              </span>
                          ...
                          <td className={`py-4 px-6 font-mono text-xs ${isJobClosed ? "text-slate-400" : "text-gray-400"}`}>
